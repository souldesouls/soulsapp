...
class EntropyCollector {
  static let shared = EntropyCollector(extractor: Extractor.shared,
                                       blockSize: UserDefaults.standard.integer(forKey: "block_size") /*Constants.blockSizes[UserDefaults.standard.integer(forKey: "block_size")] * 1024*/)
  ...
  func setBlockSize() {
    ...
    self.blockSize = UserDefaults.standard.integer(forKey: "block_size")
  }
